        ...
        <v-card color="surface" elevation="6">
          ...
          <v-card-text>
            ...
            <div v-if="accountSummary" class="mt-6">
              ...
              <div class="text-caption text-uppercase text-medium-emphasis mt-4">Portfolio Value</div>
          ...
          <v-card-text>
            <v-form @submit.prevent="submitWithdraw">
              <v-text-field
                ...
                step="0.01"
              />
              <v-btn :loading="loading.withdraw" color="primary" type="submit" block>Withdraw</v-btn>
            </v-form>
          </v-card-text>
        </v-card>
      </v-col>
            ...
            <v-table density="compact" class="mb-4">
              ...
              <tbody>
                ...
                <tr v-if="!orderBook.asks.length">
                  <td colspan="2" class="text-center text-medium-emphasis py-4">No asks available</td>
                </tr>
              </tbody>
            </v-table>
            ...
            <v-table density="compact">
              ...
              <tbody>
                ...
                <tr v-if="!orderBook.bids.length">
                  <td colspan="2" class="text-center text-medium-emphasis py-4">No bids available</td>
                </tr>
              </tbody>
            </v-table>
          </v-card-text>
            ...
            <v-table density="compact" class="text-body-2">
              ...
              <tbody>
                <tr v-for="order in orders" :key="order.id">
                  ...
                  <td :class="order.side.code === 'BUY' ? 'text-up' : 'text-down'">{{ order.side.code }}</td>
